...
from Assignment.E9_TestAppium.Pages.base_page import Base, NoSuchElementException
    ...
    def click_edit_member(self):
        ...
        try:
            ...
            if self.find(MobileBy.XPATH, "//*[@text='语音通话']"):
                ...
                from Assignment.E9_TestAppium.Pages.edit_member_page import EditMember
